#
#  Be sure to run `pod spec lint SearchableTextView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
A UITextView with search capabilites. Matched results can be navigated.
                   DESC
  ...
  s.source       = { :git => "https://github.com/IzikLisbon/SearchableTextView.git", :tag => "0.1.2" }
